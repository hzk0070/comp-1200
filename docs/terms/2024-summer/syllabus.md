...
# COMP 1230 Introduction to Computing with MATLAB <br> Summer 2024 Course Syllabus
...
*The recorded lectures will become available throughout
the semester on or ahead of the schedule outlined in the syllabus below.*
...
This course will use the Respondus Lockdown Browser and associated Respondus Monitor to proctor exams by recording your exam session through a webcam.
The Respondus Monitor requires a paid subscription which lasts 12 months and you are responsible for the fee.

You must have a compatible laptop or device capable of installing and reliably running [Respondus Lockdown Browser](http://www.respondus.com/lockdown/information.pl?ID=313412015) and a webcam.  

*Respondus Lockdown Browser installation file is different for each institution (e.g. AU at Montgomery has its own Respondus Lockdown Browser different from AU).
Please use the link given above to download the proper version instead of googling to find it on your own.*
...
Module 0 is allocated to the first 5 days of the semester and the other six
modules are each allocated 9 days (excluding holiday and other no class days). Below is a ***tentative*** 11-week schedule
for the course that indicates for each module the dates and types of graded
items due. (Note: All dates in the table below reflect the [Summer 2024 academic calendar](http://www.auburn.edu/main/auweb_calendar.php).)

Week  | Dates          | Module | Graded Items | Note 
----  | -----          | ------ | ------------ | ----
1-2   | Thu 16 May - Mon 20 May | M0     | Z            | 
2-3   | Tue 21 May - Thu 30 May	| M1     | Z            | Memorial Day (5/27)
3-4   | Fri 31 May - Sat 08 Jun | M2     | Z E T        | Exam 1 and Programming Test 1
5-6   | Sun 09 Jun - Mon 17 Jun | M3     | Z            |   
6-8   | Tue 18 Jun - Mon 01 Jul | M4     | Z E T        | Juneteenth (6/19) <br> Mini-Semester Finals Period (6/21-6/24) <br> Exam 2 and Programming Test 2
8-9   | Tue 02 Jul - Thu 11 Jul | M5     | Z            | Independence Day (7/4) 
9-10  | Fri 12 Jul - Sat 20 Jul | M6     | Z E T        | Exam 3 and Programming Test 3
10-11 | Sun 21 Jul - Mon 29 Jul | M7     |              | 


Final Exam and Final Programming Test will be available from July 31 to August 1.
...
excuses for connectivity issues within 30 minutes of an assignment/exam deadline are
